...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    %% ── field devices (DODAG leaves / intermediate nodes) ──
    \node[dev] (d1) at (0.0,  0.0) {};
    \node[dev] (d2) at (0.0,  1.0) {};
    \node[dev] (d3) at (0.8,  1.6) {};
    \node[dev] (d4) at (0.8,  0.5) {};
    \node[dev] (d5) at (0.4, -0.5) {};
    \node[dev] (d6) at (1.6,  1.0) {};

    %% ── infrastructure ──────────────────────────────────────
    \node[infra] (dap) at (3.1, 0.5) {Concentrador\\(DAP)};
    \node[infra] (he)  at (5.6, 0.5) {Head-end\\SCADA};

    %% ── RPL upward routes (toward DODAG root = DAP) ─────────
    \draw[rpl] (d1) -- (d4);
    \draw[rpl] (d2) -- (d4);
    \draw[rpl] (d5) -- (d4);
    \draw[rpl] (d3) -- (d6);
    ...
    %% ── WAN backhaul ────────────────────────────────────────
    \draw[wan] (dap) --
      node[above, font=\tiny] {LTE Band~31}
      node[below, font=\tiny] {450\,MHz / WAN}
      (he);

    %% ── FAN zone background ─────────────────────────────────
    \begin{scope}[on background layer]
      \fill[gray!10, rounded corners=5pt]
        (-0.45,-0.85) rectangle (2.35, 2.1);
    \end{scope}

    %% ── zone labels ─────────────────────────────────────────
    \node[font=\tiny, text=black!55, align=center]
      at (0.95, -1.2) {FAN --- RPL\,/\,IEEE~802.15.4g\,/\,Wi-SUN};
    \node[font=\tiny, text=black!55]
      at (4.35, -1.2) {WAN};

    %% ── device legend ───────────────────────────────────────
    \node[dev, scale=0.7] at (0.0, 2.55) {};
    \node[font=\tiny, text=black!60, right]
      at (0.15, 2.55) {Medidor\,/\,Sensor\,/\,Atuador};
  \end{tikzpicture}
